...
{
    /// <summary>
    /// Interface for locating a variable length flyweight over a<see><cref>byte[]</cref></see>
    /// </summary>
    public interface IMessageFlyweight
    {
        ...
        /// <param name="buffer">buffer underlying the message.</param>
        /// <param name="offset">offset at which the message body begins.</param>
        /// <param name="actingBlockLength">block length to be used when decoding the message.</param>
        /// <param name="actingVersion">version of the template to be used with decoding the message.</param>
